...
constexpr size_t MAXIMUM_NODE_SIZE_IN_LONGS = 65536u;

/*
 * every object of type HOTSingleThreadedNodeBase will be aligned to 8-byte boundary
 * the HOTSingleThreadedChildPointer class may be allowed to access provate members of HOTSingleThreadedNodeBase
