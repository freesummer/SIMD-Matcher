...
#include <hot/commons/include/hot/commons/PartialKeyConversionInformation.hpp>
...
public:
  ...
  inline HOTSingleThreadedChildPointer* searchForInsert(hot::commons::SearchResultForInsert & searchResultOut, uint8_t const * keyBytes, uint64_t mask) const;
